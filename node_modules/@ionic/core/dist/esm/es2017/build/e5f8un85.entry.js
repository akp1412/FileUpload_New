...
import { a as attachComponent } from './chunk-b9ec67ac.js';
import { h as assert } from './chunk-03ecffc3.js';
import { b as lifecycle, c as setPageHidden, d as transition } from './chunk-68ea58b8.js';
...
class Nav {
    ...
    componentDidUnload() {
        for (const view of this.views) {
            lifecycle(view.element, "ionViewWillUnload");
            view._destroy();
        }
        if (this.gesture) {
    ...
    postViewInit(enteringView, leavingView, ti) {
        ...
        if (destroyQueue && destroyQueue.length > 0) {
            for (const view of destroyQueue) {
                lifecycle(view.element, "ionViewWillLeave");
                lifecycle(view.element, "ionViewDidLeave");
                lifecycle(view.element, "ionViewWillUnload");
            }
            for (const view of destroyQueue) {
    ...
    cleanup(activeView) {
        ...
        for (let i = views.length - 1; i >= 0; i--) {
            ...
            if (i > activeViewIndex) {
                lifecycle(element, "ionViewWillUnload");
                this.destroyView(view);
            }
