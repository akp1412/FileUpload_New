...
class Note {
    ...
    static get style() { return ":host{color:var(--color);font-family:var(--ion-font-family,inherit);-webkit-box-sizing:border-box;box-sizing:border-box}:host(.ion-color){color:var(--ion-color-base)}:host{--color:var(--ion-text-color-step-400,#666);font-size:14px}"; }
    static get styleMode() { return "md"; }
}
