...
import { h as createColorClasses, k as createThemedClasses } from './chunk-b9ec67ac.js';
...
class CardSubtitle {
    ...
    static get style() { return ":host{display:block;position:relative;color:var(--color)}:host(.ion-color){color:var(--ion-color-base)}:host{--color:var(--ion-text-color-step-400,#666);margin:0 0 4px;padding:0;font-size:12px;font-weight:700;letter-spacing:.4px;text-transform:uppercase}"; }
    static get styleMode() { return "ios"; }
}
...
class CardTitle {
    ...
    static get style() { return ":host{display:block;position:relative;color:var(--color)}:host(.ion-color){color:var(--ion-color-base)}:host{--color:var(--ion-text-color,#000);margin:0;padding:0;font-size:28px;font-weight:700;line-height:1.2}"; }
    static get styleMode() { return "ios"; }
}
