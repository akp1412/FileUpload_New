...
class ListHeader {
    ...
    static get style() { return ".sc-ion-list-header-ios-h{-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased;margin:0;padding:0;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-ms-flex-pack:justify;justify-content:space-between;width:100%;min-height:40px;background:var(--background);color:var(--color);overflow:hidden}.ion-color.sc-ion-list-header-ios-h{background:var(--ion-color-base);color:var(--ion-color-contrast)}.sc-ion-list-header-ios-h{--background:transparent;--color:var(--ion-text-color-step-150,#262626);padding-left:calc(var(--ion-safe-area-left, 0px) + 16px);position:relative;font-size:12px;font-weight:500;letter-spacing:1px;text-transform:uppercase}"; }
    static get styleMode() { return "ios"; }
}
...
class Note {
    ...
    static get style() { return ".sc-ion-note-ios-h{color:var(--color);font-family:var(--ion-font-family,inherit);-webkit-box-sizing:border-box;box-sizing:border-box}.ion-color.sc-ion-note-ios-h{color:var(--ion-color-base)}.sc-ion-note-ios-h{--color:var(--ion-text-color-step-650,#a6a6a6)}"; }
    static get styleMode() { return "ios"; }
}
...
class SkeletonText {
    ...
    static get style() { return ".sc-ion-skeleton-text-ios-h{width:100%;pointer-events:none;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.sc-ion-skeleton-text-ios-h, span.sc-ion-skeleton-text-ios{display:inline-block}span.sc-ion-skeleton-text-ios{font-size:8px}.sc-ion-skeleton-text-ios-h{--background:var(--ion-text-color,#000)}span.sc-ion-skeleton-text-ios{background:var(--background);opacity:.1}"; }
    static get styleMode() { return "ios"; }
}
