...
class CardSubtitle {
    ...
    static get style() { return ".sc-ion-card-subtitle-md-h{display:block;position:relative;color:var(--color)}.ion-color.sc-ion-card-subtitle-md-h{color:var(--ion-color-base)}.sc-ion-card-subtitle-md-h{--color:var(--ion-text-color-step-450,#737373);margin:0;padding:0;font-size:14px;font-weight:500}"; }
    static get styleMode() { return "md"; }
}
...
class CardTitle {
    ...
    static get style() { return ".sc-ion-card-title-md-h{display:block;position:relative;color:var(--color)}.ion-color.sc-ion-card-title-md-h{color:var(--ion-color-base)}.sc-ion-card-title-md-h{--color:var(--ion-text-color-step-150,#262626);margin:0;padding:0;font-size:20px;font-weight:500;line-height:1.2}"; }
    static get styleMode() { return "md"; }
}
