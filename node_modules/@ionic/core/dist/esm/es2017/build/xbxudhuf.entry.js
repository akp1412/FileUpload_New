...
class CardSubtitle {
    ...
    static get style() { return ":host{display:block;position:relative;color:var(--color)}:host(.ion-color){color:var(--ion-color-base)}:host{--color:var(--ion-text-color-step-450,#737373);margin:0;padding:0;font-size:14px;font-weight:500}"; }
    static get styleMode() { return "md"; }
}
...
class CardTitle {
    ...
    static get style() { return ":host{display:block;position:relative;color:var(--color)}:host(.ion-color){color:var(--ion-color-base)}:host{--color:var(--ion-text-color-step-150,#262626);margin:0;padding:0;font-size:20px;font-weight:500;line-height:1.2}"; }
    static get styleMode() { return "md"; }
}
