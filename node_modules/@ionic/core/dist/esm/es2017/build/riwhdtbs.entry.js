...
import { j as debounce } from './chunk-03ecffc3.js';
import { a as attachComponent, b as detachComponent } from './chunk-b9ec67ac.js';
import { d as transition } from './chunk-68ea58b8.js';
...
class RouterOutlet {
    ...
    async componentDidLoad() {
        this.gesture = (await import("./swipe-back.js")).createSwipeBackGesture(this.el, this.queue, () => !!this.swipeHandler && this.swipeHandler.canStart(), () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
