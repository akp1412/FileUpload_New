...
class Note {
    ...
    static get style() { return ".sc-ion-note-md-h{color:var(--color);font-family:var(--ion-font-family,inherit);-webkit-box-sizing:border-box;box-sizing:border-box}.ion-color.sc-ion-note-md-h{color:var(--ion-color-base)}.sc-ion-note-md-h{--color:var(--ion-text-color-step-400,#666);font-size:14px}"; }
    static get styleMode() { return "md"; }
}
...
class SkeletonText {
    ...
    static get style() { return ".sc-ion-skeleton-text-md-h{width:100%;pointer-events:none;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.sc-ion-skeleton-text-md-h, span.sc-ion-skeleton-text-md{display:inline-block}span.sc-ion-skeleton-text-md{font-size:8px}.sc-ion-skeleton-text-md-h{--background:var(--ion-text-color,#000)}span.sc-ion-skeleton-text-md{background:var(--background);opacity:.1}"; }
    static get styleMode() { return "md"; }
}
