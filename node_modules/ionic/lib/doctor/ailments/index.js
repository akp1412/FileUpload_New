...
class GitConfigInvalid extends base_1.Ailment {
    ...
    getMessage() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return (`App linked to ${chalk_1.default.bold(proId)} with invalid git configuration.\n` +
                `This app is linked to an app on Ionic (${chalk_1.default.bold(proId)}), but the git configuration is not valid.\n`).trim();
        });
    }
    detected() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    getTreatmentSteps() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return [
                ...
                { message: `Refer to ${chalk_1.default.bold('https://ionicframework.com/docs/native')} for installation & usage instructions` },
            ];
        });
    }
}
