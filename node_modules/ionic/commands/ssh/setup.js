    ...
    getMetadata() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return {
                ...
                description: `
This command offers a setup wizard for Ionic Pro SSH keys using a series of prompts. For more control, see the commands available for managing SSH keys with the ${chalk_1.default.green('ionic ssh --help')} command. For an entirely manual approach, see ${chalk_1.default.bold('Personal Settings')} => ${chalk_1.default.bold('SSH Keys')} in the Dashboard${chalk_1.default.cyan('[1]')}.

If you are having issues setting up SSH keys, please get in touch with our Support${chalk_1.default.cyan('[2]')}.

${chalk_1.default.cyan('[1]')}: ${chalk_1.default.bold('https://dashboard.ionicframework.com/settings/ssh-keys')}
