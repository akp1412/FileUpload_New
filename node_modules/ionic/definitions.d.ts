...
export declare type ProjectType = 'angular' | 'ionic-angular' | 'ionic1' | 'custom' | 'bare';
...
export declare type IntegrationName = 'capacitor' | 'cordova';
...
export declare type HydratedCommandMetadata = CommandMetadata & ζframework.HydratedCommandMetadata<ICommand, INamespace, CommandMetadata, ζframework.CommandMetadataInput, CommandMetadataOption>;
export declare type CommandInstanceInfo = ζframework.CommandInstanceInfo<ICommand, INamespace, CommandMetadata, ζframework.CommandMetadataInput, CommandMetadataOption>;
export declare type NamespaceLocateResult = ζframework.NamespaceLocateResult<ICommand, INamespace, CommandMetadata, ζframework.CommandMetadataInput, CommandMetadataOption>;
...
export interface IClient {
    ...
    make(method: HttpMethod, path: string): Promise<{
        req: ζsuperagent.SuperAgentRequest;
    }>;
...
export declare type InfoItemGroup = 'ionic' | 'capacitor' | 'cordova' | 'system' | 'environment';
