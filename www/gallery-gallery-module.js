...
var GalleryPage = /** @class */ (function () {
        ...
        this.slides.getPreviousIndex().then(function (prevInd) {
            _this.slides.getActiveIndex().then(function (val) {
                ...
                if (_this.masterDetailService.filteredImgList[_this.firstSlideIndex + val].imgAlbum === '') {
                    ...
                    _this.hasAlbum = true;
                    _this.strAlbum = _this.masterDetailService.filteredImgList[_this.firstSlideIndex + val].imgAlbum + " : " + _this.masterDetailService.filteredImgList[_this.firstSlideIndex + val].imgMonth + "-" + _this.masterDetailService.filteredImgList[_this.firstSlideIndex + val].imgYear;
                }
    ...
    GalleryPage.prototype.ngOnInit = function () {
        ...
        var currentIndex = currIndex - this.firstSlideIndex;
    ...
    GalleryPage.prototype.imageClicked = function () {
